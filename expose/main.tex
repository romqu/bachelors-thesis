...
\addbibresource{references/references-02.bib}
\usepackage{hyperref}
\usepackage{xcolor}
\hypersetup{
	colorlinks,
...
\begin{document}
	...
	\input{04-specific-tasks/specific-tasks.tex}

	\newpage

	\input{05-early-structure/early-structure.tex}

	\newpage

	\input{06-timetable/timetable.tex}
	
	\newpage
	
	\input{07-signatures/signatures.tex}
