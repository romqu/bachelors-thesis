...
A developer must be aware of all the possible outcomes, \todo{Talk about routing/user flow/navigation} react to them and save what has happened.
The developer must manage the state. The problem is to find a good design pattern, which makes this task feasible. \todo{in such a way that it respects SOLID/DRY etc}
