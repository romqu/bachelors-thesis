...
\\
Ein besser Ansatz bildet dabei Nummer zwei. Anstatt mit einer Klasse sämtliche Intentionen abbilden zu wollen, erscheint es sinnvoller, für jede Intention eine Klasse zu kreieren. Gleichzeitig sollte aber verhindert  
