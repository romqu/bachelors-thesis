...
\end{lstlisting}
\bigskip
Wie zu erkennen ist nach 'System.out.println(var4);' Schluss und 'println("Ende");' wurde nicht übernommen.
\\\\
Auch in dieser Angelegenheit kann Kotlin mit einem weiteren Schlüsselwort aushelfen: 'crossinline'. Dies besagt, dass kein 'return' Statement erlaubt ist.
